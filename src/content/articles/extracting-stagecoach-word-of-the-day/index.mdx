...
<Image
	src={jadxInitial}
	alt="jadx successfully loading the Stagecoach apk"
	description="Success!"
	height={800}
/>
...
<Link href="https://github.com/Ayrx/JNIAnalyzer/blob/7170ce6bd138caa6be702e357b3aeb74231ae12f/JNIAnalyzer/data/jni_all.gdt">
	someone
</Link>
had already created a GDT archive for us to use with JNI code.
