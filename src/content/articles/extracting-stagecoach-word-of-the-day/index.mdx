...
<Image src={app} alt="Example of the ticket view in the Stagecoach app" height={600} eager />
...
<Image src={jadxInitial} alt="jadx successfully loading the Stagecoach apk" description="Success!" eager />
